        ...
        for file in files:
            try:
                with open(file, "r", encoding="utf-8") as f:
                    ...
                    print(
                        f"JSONLoader | Actions | séquence '{identifiant}' chargée ({len(self.actions_sequences[identifiant])} actions)")
        ...
        for file in files:
            try:
                with open(file, "r", encoding="utf-8") as f:
                    ...
                    print(f"JSONLoader | Items | {content['id']} chargé")
            except Exception as e:
            ...
            try:
                with open(file) as f:
                    ...
                    if "rencontre" in content and content["rencontre"]:
                        ...
                        print(f"JSONLoader | NPC | {identifiant} > action de rencontre créer")
